...
VALUES
  ...
  ((SELECT id FROM Dogs WHERE name='largedog'), '2025-06-10 10:00:00', 60, 'Central Park', 'pending'),
  ((SELECT id FROM Dogs WHERE name='mediumdog'), '2025-06-11 11:30:00', 20, 'Maple Street', 'accepted'),
  ((SELECT id FROM Dogs WHERE name='smalldog'), '2025-06-12 14:00:00', 40, 'Oak Avenue', 'rejected');